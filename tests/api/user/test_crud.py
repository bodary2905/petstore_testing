...
def test_crud():
    ...
    with allure.step("Create User"):
        allure.attach(json.dumps(USER_BODY_CREATE), name="body_for_create", attachment_type=AttachmentType.JSON)
    ...
    with allure.step("Get User after Create and check it"):
        ...
        allure.attach(json.dumps(get_body), name="body_after_create", attachment_type=AttachmentType.JSON)
    ...
    with allure.step("Update User"):
        allure.attach(json.dumps(USER_BODY_UPDATE), name="body_for_update", attachment_type=AttachmentType.JSON)
    ...
    with allure.step("Get User after Update and check it"):
        ...
        allure.attach(json.dumps(get_body), name="body_after_update", attachment_type=AttachmentType.JSON)
        # удаляем поле "id" из словаря
